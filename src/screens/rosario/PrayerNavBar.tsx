...
export function PrayerNavBar({
  ...
  return (
    <nav className="relative z-30 shrink-0 border-t border-white/10 bg-[#0a0a0b]/90 backdrop-blur-xl">
      <div className="mx-auto flex max-w-md items-end justify-between px-6 pb-5 pt-2">
        {/* Left: Salir */}
        <button
          onClick={onExit}
          className="flex min-h-[44px] min-w-[56px] flex-col items-center justify-center gap-1 text-white/45"
        >
